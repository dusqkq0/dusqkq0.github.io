...
(function () {
  ...
  var CSS = [
    ...
    '.pres-slide .ps-inner{position:absolute;top:64px;left:80px;right:80px;bottom:80px;overflow:hidden;}',
    '.pres-slide .ps-eyebrow{font-size:18px;font-weight:700;letter-spacing:.06em;color:#767676;text-transform:uppercase;margin-bottom:14px;}',
    '.pres-slide .ps-title{font-size:48px;font-weight:700;letter-spacing:-.02em;line-height:1.15;color:#191919;margin-bottom:22px;}',
    '.pres-slide .ps-subhead{font-size:24px;font-weight:700;color:#545454;margin:-8px 0 18px;}',
    '.pres-slide .ps-meta{font-size:14px;color:#a1a1a1;margin:-12px 0 16px;}',
    '.pres-slide .ps-lede{font-size:22px;line-height:1.6;color:#545454;margin-bottom:14px;font-weight:500;}',
    '.pres-slide .ps-lede b{color:#191919;font-weight:700;}',
    '.pres-slide .ps-foot{position:absolute;left:80px;right:80px;bottom:34px;display:flex;justify-content:space-between;font-size:14px;color:#a1a1a1;border-top:1px solid #ededed;padding-top:12px;}',
    '.pres-slide .ps-stats{display:grid;gap:1px;background:#e3e3e3;border:1px solid #e3e3e3;margin:6px 0 16px;}',
    '.pres-slide .ps-stat{background:#fff;padding:26px 22px;}',
    '.pres-slide .ps-stat .v{font-size:38px;font-weight:700;color:#191919;line-height:1.1;letter-spacing:-.02em;}',
    ...
    '.pres-slide .ps-step{flex:1;background:#f7f7f7;border:1px solid #e3e3e3;padding:20px 12px;text-align:center;}',
    ...
    '.pres-slide .ps-card{background:#fff;padding:24px 24px;}',
    ...
    '.pres-slide .ps-note{padding:22px 26px;margin:8px 0 16px;background:rgba(252,246,131,.30);}',
    ...
    '.pres-slide .ps-note p{font-size:18px;line-height:1.65;color:#191919;}',
    '.pres-slide .ps-note p b{color:#191919;font-weight:700;}',
    '.pres-slide .ps-table{width:100%;border-collapse:collapse;margin:8px 0 16px;font-size:17px;border-top:1px solid #191919;border-bottom:1px solid #191919;}',
    '.pres-slide .ps-table thead th{text-align:left;background:#efefef;color:#191919;font-weight:600;text-transform:uppercase;letter-spacing:.03em;font-size:14px;padding:12px 16px;}',
    '.pres-slide .ps-table thead th.num{text-align:right;}',
    '.pres-slide .ps-table tbody td{padding:13px 16px;border-bottom:1px solid #ededed;color:#2e2e2e;line-height:1.5;}',
    ...
    '.pres-slide .ps-fig{background:#f0f0f0;border:1px solid #e3e3e3;display:flex;align-items:center;justify-content:center;overflow:hidden;height:380px;}',
    '.pres-slide .ps-fig.med{height:300px;}',
